...
const sequelize: Sequelize = new Sequelize('postgresql://postgres:postgres@database-1.cb4vwu4uvc8e.eu-west-3.rds.amazonaws.com:5432/postgres', {
	logging: false
})
...
export { models, modelsBuilder, sequelize, db }
